...
// Corrections:
console.log('\n\nCORRECTIONS (for 1, 3 & 4):');
//1.
console.log('\n1. Square of numbers function: ');
...
// 3.
console.log('\n3. Function that has two parameters time and name, that returns a string "with a greeting" containing the time and name: ');
...
// 4.
console.log('\n4. Function that dynamically increment the values of an array only when those values are greater than 10');
